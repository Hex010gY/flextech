...
export const metadata: Metadata = {
  title: 'Flex Computers — Premium Laptops & Accessories in Rotterdam',
  description:
    'Discover the best laptops and computing accessories at Flex Computers, Rotterdam. Gaming, business, and student laptops from top brands.',
};
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="relative hidden lg:flex items-center justify-center animate-float">
                <div className="relative w-full max-w-md aspect-square">
                  ...
                  <div className="relative z-10 w-full h-full rounded-[2.5rem] bg-white/5 border border-white/10 backdrop-blur-sm flex items-center justify-center overflow-hidden">
                    {/* Placeholder hero image — replace with your laptop photo */}
          ...
          <div className="container-page">
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
              {features.map((f, i) => (
                <div
                  key={f.title}
                  className="flex items-start gap-4 p-5 rounded-2xl bg-slate-50 dark:bg-slate-800/40 border border-slate-100 dark:border-slate-700/40 hover:border-blue-200 dark:hover:border-blue-700/50 transition-colors"
            ...
            <div className="container-page">
              <div className="flex items-end justify-between mb-10">
                ...
                <Link
                  ...
                  className="hidden sm:flex items-center gap-1.5 text-sm font-semibold text-blue-600 dark:text-blue-400 hover:gap-2.5 transition-all"
                >
                  View all
            ...
            <div className="grid grid-cols-4 sm:grid-cols-8 gap-4">
              {brands.map((brand) => (
                <Link
                  ...
                  className="flex items-center justify-center py-4 px-3 rounded-xl border border-slate-100 dark:border-slate-800 hover:border-blue-300 dark:hover:border-blue-700 hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-all group"
                >
        ...
        <section className="py-16 bg-gradient-to-r from-blue-600 to-blue-800">
          <div className="container-page text-center text-white">
            ...
            <p className="text-blue-200 text-lg mb-8 max-w-xl mx-auto">
              Our experts are ready to help. Contact us on WhatsApp and we'll find the
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-8 py-4 bg-white text-blue-700 font-bold rounded-2xl hover:bg-blue-50 shadow-lg hover:shadow-xl transition-all duration-200"
            >
              Chat with an Expert →
            </a>
          </div>
